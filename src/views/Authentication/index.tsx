...
import SignInBackground from "src/assents/image/sign-in-background.png";
import SignUpBackground from "src/assents/image/sign-up-background.png";
        ...
        <div className="authentication-sns-container">
            ...
            <div className="sns-button-container">
                <div
                    ...
                    onClick={() => {
                        onSnsButtonClickHandler("kakao");
                    }}
                ></div>
                <div
                    className="sns-button naver-button"
                    onClick={() => {
                        onSnsButtonClickHandler("naver");
                    }}
                ></div>
            </div>
        </div>
...
function SignIn({ onLinkClickHandler }: Props) {
    ...
    const onSignInButtonClickHandler = () => {
        ...
        const reqeustBody: SignInRequestDto = {
            userId: id,
            userPassword: password,
        };
        SignInRequest(reqeustBody).then(signInResponse);
    };
...
function SignUp({ onLinkClickHandler }: Props) {
    ...
    const onIdButtonClickHandler = () => {
        ...
        const reqeustBody: IdCheckRequestDto = { userId: id };
    ...
    const onEmailButtonClickHandler = () => {
        ...
        const reqeustBody: EmailAuthRequestDto = { userEmail: email };
        emailAuthRequest(reqeustBody).then(emailAuthResponse);
    };
    ...
    const onAuthNumberButtonClickHandler = () => {
        ...
        const requestBody: EmailAutCheckRequestDto = {
            userEmail: email,
            authNumber,
        };
    ...
    return (
        <div className="authentication-contents">
            ...
            <div className="authentication-button-container">
                <div className={signUpButtonClass} onClick={onSignUpButtonClickHandler}>
                    회원가입
                </div>
                <div className="text-link" onClick={onLinkClickHandler}>
                    로그인
...
export default function Authentication() {
    ...
    const AuthenticationContents =
        page === "sign-in" ? <SignIn onLinkClickHandler={onLinkClickHandler} /> : <SignUp onLinkClickHandler={onLinkClickHandler} />;
